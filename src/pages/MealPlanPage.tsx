    ...
    <div className="max-w-2xl mx-auto py-8 px-4 sm:py-16">
      <header className="text-center mb-10">
        ...
        <p className="mt-3 text-muted-foreground max-w-md mx-auto">
          Get a dynamically generated daily menu tailored to your calorie target.
        </p>
      </header>

      <div className="rounded-2xl border bg-card p-6 shadow-sm mb-6">
        <Label className="text-sm text-muted-foreground mb-2 block">Target Calories (kcal)</Label>
        <Input
          type="number"
          min="1000"
          max="6000"
